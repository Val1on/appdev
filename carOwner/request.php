            ...
            <div class="bg-gray-800 rounded-xl p-4 sm:p-6 border border-gray-700">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center space-x-3">
                        <button class="flex items-center justify-center px-3 py-1.5 sm:px-4 sm:py-2   bg-blue-500 text-white rounded-md text-xs sm:text-sm e font-medium hover:bg-blue-600 transition-colors duration-200">
