...
<body class="bg-gray-700">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-100">My Trips</h1>
        </div>
        ...
        <div class="mb-6 border-b border-gray-700">
            ...
            <nav class="flex space-x-8">
                <a href="trips.php" class="px-1 py-4 text-blue-400 border-b-2 border-blue-400 font-medium">
                Trips
                </a>
            ...
            <a href="post.php" class="px-4 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition-colors duration-200 text-center sm:text-left">
                Post a Trip
            </a>
            </div>
        </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-1">
                                ...
                                <p class="text-sm sm:text-base text-gray-400">Feb 25, 2024 • 2:30 PM</p>
