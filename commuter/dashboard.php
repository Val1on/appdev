    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-lg sm:text-xl lg:text-1xl font-bold text-gray-100">Welcome back to your commuter dashboard!</h3>
                        <p class="text-sm sm:text-base text-blue-400">Commuter</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-gray-700 bg-opacity-50 rounded-lg p-4 hover:bg-gray-600/50 transition-colors duration-200">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-sm sm:text-base lg:text-lg font-medium text-gray-100 truncate">Bus Route 123</h4>
                                </div>
                                <p class="text-xs sm:text-sm text-gray-400 mt-1">Feb 26, 2024 • 9:00 AM</p>
                                <p class="text-xs sm:text-sm text-gray-400 mt-1">From: Manila to Quezon City</p>
                            </div>
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg border border-gray-700 overflow-hidden">
            <div class="p-3 sm:p-4 lg:p-5 border-b border-gray-700 flex items-center justify-between">
                ...
                <span class="text-xs sm:text-sm text-gray-400">2 trips</span>
            </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div class="space-y-2">
                            <div class="flex items-center space-x-2">
                                <h3 class="text-sm sm:text-base lg:text-lg font-medium text-gray-100">Train Route 456</h3>
