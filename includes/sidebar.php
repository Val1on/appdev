...
<body>
    ...
    <header class="fixed top-0 left-0 w-full bg-gray-800 shadow-md z-40">
        <div class="flex items-center justify-between px-2 sm:px-4 py-2 sm:py-3 lg:pl-64">
         
            <div class="flex items-center space-x-2 sm:space-x-4">
                <button id="sidebarToggle" class="p-1 sm:p-2 rounded-md lg:hidden hover:bg-gray-800">
    ...
    <div id="sidebar" class="fixed left-0 top-0 w-48 sm:w-56 lg:w-64 h-screen bg-gray-900 text-white transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out z-50 flex flex-col">
        ...
        <ul class="flex-1 mt-2 sm:mt-4">
            <li class="p-2 sm:p-3 lg:p-4 hover:bg-gray-700">
