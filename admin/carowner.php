        ...
        <div id="tableView" class="bg-green-600 shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800">
                <table class="min-w-full divide-y divide-green-700">
                    <thead class="bg-green-600">
                        <tr>
                            <th class="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-white uppercase tracking-wider">Owner NO</th>
                    ...
                    <tbody class="bg-green-600 divide-y divide-green-700">
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr class="hover:bg-green-700 transition-colors duration-200">
                                <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm text-white"><?php echo $row['ownerNO']; ?></td>
                                ...
                                <a href="edit_car_owner.php?ownerNO=<?php echo $row['ownerNO']; ?>" class="text-green-100 hover:text-green-300 mr-3 text-xs sm:text-sm">
                                    Edit
                                </a>
            ...
            <div class="px-4 sm:px-6 py-4 border-t border-green-700">
                <div class="flex flex-col sm:flex-row items-center justify-between space-y-2 sm:space-y-0">
                    <a href="create_carowner.php" class="w-full sm:w-auto bg-green-500 text-white px-4 py-2 rounded-md text-xs sm:text-sm font-medium hover:bg-green-700 transition-colors duration-200 text-center">
                        Add New Car Owner
                    </a>
