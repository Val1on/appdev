            ...
            <div class="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800">
                <table class="min-w-full divide-y divide-gray-700">
                    <thead class="bg-gray-800">
                        <tr>
                            <th class="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-300 uppercase tracking-wider">Feedback No</th>
                            <th class="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-300 uppercase tracking-wider">Feedback Message</th>
                            <th class="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-medium text-gray-300 uppercase tracking-wider">Rating</th>
                    ...
                    <tbody class="bg-gray-800 divide-y divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-700 transition-colors duration-200">
                            ...
                            <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-xs sm:text-sm text-gray-300">Great service and very professional!</td>
...
<div id="formView" class="bg-gray-800 shadow-xl rounded-lg overflow-hidden hidden max-w-5xl mx-auto p-2 sm:p-4 lg:p-6">
    ...
    <div class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5 border-b border-gray-700">
        <h2 class="text-base sm:text-lg lg:text-xl font-semibold text-white">Add New Feedback</h2>
    </div>
    

    <div class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5">
        <form id="feedbackForm" class="space-y-3 sm:space-y-4 lg:space-y-5">
            <div class="grid grid-cols-1 gap-3 sm:gap-4 lg:gap-6">

                <div class="relative">
                    <label for="feedbackMessage" class="block text-xs sm:text-sm lg:text-base font-medium text-gray-300 mb-1 sm:mb-2">
                        Feedback Message
                    </label>
                    <textarea name="feedbackMessage" id="feedbackMessage" required rows="4"
...
<div id="editFormView" class="bg-gray-800 shadow-xl rounded-lg overflow-hidden hidden max-w-5xl mx-auto p-2 sm:p-4 lg:p-6">
    ...
    <div class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-5">
        <form id="editFeedbackForm" class="space-y-3 sm:space-y-4 lg:space-y-5">
            <input type="hidden" id="editFeedbackId">
            <div class="grid grid-cols-1 gap-3 sm:gap-4 lg:gap-6">
             
                <div class="relative">
                    <label for="editFeedbackMessage" class="block text-xs sm:text-sm lg:text-base font-medium text-gray-300 mb-1 sm:mb-2">
                        Feedback Message
                    </label>
                    <textarea name="editFeedbackMessage" id="editFeedbackMessage" required rows="4"
                        class="block w-full px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm lg:text-base rounded-md 
                        bg-gray-700 border border-gray-600 text-gray-100 placeholder-gray-400 
                        focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 
                        focus:ring-opacity-50 transition-colors duration-200"
                ...
                <div class="relative">
                    <label for="editRating" class="block text-xs sm:text-sm lg:text-base font-medium text-gray-300 mb-1 sm:mb-2">
                        Rating
                    </label>
